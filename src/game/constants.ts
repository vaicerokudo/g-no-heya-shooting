...
export const ROCKEL_SUPPORT_BREAK_COOLDOWN = 4.2;
export const ROCKEL_SUPPORT_BREAK_MIN_COOLDOWN = 3.0;
export const ROCKEL_SUPPORT_BREAK_DURATION = 0.34;
export const ROCKEL_SUPPORT_BREAK_RANGE = 152;
export const ROCKEL_SUPPORT_BREAK_HALF_WIDTH = 116;
export const ROCKEL_SUPPORT_BREAK_DAMAGE = 1;
export const ROCKEL_SUPPORT_BREAK_BOSS_DAMAGE = 1;
