...
export const NANAICHI_ICE_SWORD_COOLDOWN = 1.1;
export const NANAICHI_ICE_SWORD_VISIBLE_TIME = 0.18;
export const NANAICHI_ICE_SHARD_DAMAGE = 1;
export const NANAICHI_ICE_SHARD_BOSS_DAMAGE = 1;
export const NANAICHI_ICE_SHARD_SPEED = 380;
export const NANAICHI_ICE_SHARD_RADIUS = 4.8;
export const NANAICHI_ICE_SHARD_LIFE = 1.25;
export const NANAICHI_ICE_SHARD_SLOW_TIME = 1.2;

export const MYOO_FLAME_SWORD_COOLDOWN = 1.25;
export const MYOO_FLAME_SWORD_VISIBLE_TIME = 0.2;
export const MYOO_FLAME_BULLET_DAMAGE = 1;
export const MYOO_FLAME_BULLET_BOSS_DAMAGE = 1;
export const MYOO_FLAME_BULLET_SPEED = 360;
export const MYOO_FLAME_BULLET_RADIUS = 5.2;
export const MYOO_FLAME_BULLET_LIFE = 0.62;
...
export const ROKUDO_SUPPORT_POISON_INTERVAL = 8.0;
export const ROKUDO_SUPPORT_POISON_MIN_INTERVAL = 6.0;
export const ROKUDO_SUPPORT_POISON_DURATION = 3.0;
export const ROKUDO_SUPPORT_POISON_MAX_DURATION = 4.5;
export const ROKUDO_SUPPORT_POISON_RADIUS = 72;
export const ROKUDO_SUPPORT_POISON_SLOW_MULTIPLIER = 0.58;
export const ROKUDO_SUPPORT_POISON_BOSS_SLOW_MULTIPLIER = 0.88;
export const ROKUDO_SUPPORT_POISON_DAMAGE_INTERVAL = 1.1;
export const ROKUDO_SUPPORT_POISON_DAMAGE = 1;
export const ROKUDO_SUPPORT_POISON_BOSS_DAMAGE = 1;
...
export const HIBIKI_SHIELD_BASH_COOLDOWN = 1.0;
export const HIBIKI_SHIELD_BASH_VISIBLE_TIME = 0.2;
export const HIBIKI_SHIELD_BASH_RANGE = 86;
export const HIBIKI_SHIELD_BASH_BOSS_RANGE = 110;
export const HIBIKI_SHIELD_BASH_HALF_WIDTH = 58;
export const HIBIKI_SHIELD_BASH_DAMAGE = 1;
export const HIBIKI_SHIELD_BASH_BOSS_DAMAGE = 1;
export const HIBIKI_SHIELD_BASH_KNOCKBACK = 42;
export const IRONWALL_SHOCKWAVE_VISIBLE_TIME = 0.32;
export const IRONWALL_SHOCKWAVE_COOLDOWN = 6.0;
export const IRONWALL_SHOCKWAVE_MIN_COOLDOWN = 4.4;
export const IRONWALL_SHOCKWAVE_RANGE = 142;
export const IRONWALL_SHOCKWAVE_HALF_WIDTH = 54;
export const IRONWALL_SHOCKWAVE_DAMAGE = 1;
export const IRONWALL_SHOCKWAVE_BOSS_DAMAGE = 1;
export const IRONWALL_SHOCKWAVE_KNOCKBACK = 48;
...
export const SOCHO_SUPPORT_SLASH_COOLDOWN = 4.2;
export const SOCHO_SUPPORT_SLASH_MIN_COOLDOWN = 3.0;
export const SOCHO_SUPPORT_SLASH_DURATION = 0.32;
export const SOCHO_SUPPORT_SLASH_RANGE = 116;
export const SOCHO_SUPPORT_SLASH_HALF_WIDTH = 78;
export const SOCHO_SUPPORT_SLASH_DAMAGE = 1;
export const SOCHO_SUPPORT_SLASH_BOSS_DAMAGE = 1;

export const TSUTSU_SUPPORT_ARROW_COOLDOWN = 4.2;
export const TSUTSU_SUPPORT_ARROW_MIN_COOLDOWN = 3.0;
export const TSUTSU_SUPPORT_ARROW_SPEED = 360;
export const TSUTSU_SUPPORT_ARROW_DAMAGE = 1;
export const TSUTSU_SUPPORT_ARROW_RADIUS = 4;
export const TSUTSU_SUPPORT_ARROW_LIFE = 1.35;
